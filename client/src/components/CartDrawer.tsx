...
export default function CartDrawer({ isOpen, onClose, cart, onUpdate, onCheckout }: any) {
        ...
        <ScrollArea className="flex-1 pr-4">
          {cart.length === 0 ? (
            ...
            <div className="space-y-4">
              {cart.map((item: any) => (
                <div key={item._id} className="flex justify-between items-start gap-4 pl-4">
                  <div className="">
                  ...
                  <div className="flex items-center gap-2">
                    <Button variant="outline" size="sm" onClick={() => onUpdate(item._id, -1)}>-</Button>
